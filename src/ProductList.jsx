...
function ProductList({ onHomeClick }) {
    ...
    const handleAddToCart = (product) => {
        // ensure a quantity field and dispatch to redux
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA} className="cart-badge-container">
                            <h1 className='cart' style={{ display: 'inline-block', margin: 0 }}>
            ...
            {showCheckout ? (
                ...
                <CartItem onContinueShopping={handleContinueShopping} onCheckout={handleProceedToCheckout} />
            )}
        </div>
    );
}
